...
ActiveRecord::Schema.define(version: 20171014153820) do
  ...
  create_table "schedule_service_items", force: :cascade do |t|
    t.integer  "service_id"
    t.integer  "schedule_service_id"
    t.integer  "status"
    t.date     "date"
    t.datetime "created_at",          null: false
    t.datetime "updated_at",          null: false
    t.index ["schedule_service_id"], name: "index_schedule_service_items_on_schedule_service_id", using: :btree
    t.index ["service_id"], name: "index_schedule_service_items_on_service_id", using: :btree
  end
  ...
  create_table "schedule_services", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["client_id"], name: "index_schedule_services_on_client_id", using: :btree
  end
  ...
  add_foreign_key "schedule_service_items", "schedule_services"
  add_foreign_key "schedule_service_items", "services"
  add_foreign_key "schedule_services", "clients"
